It is a personal project only. Information provided is only to show the possibility of such an assembly as no working and fully functional stack: Arduino Nano + TEA5676 was found in the internet. Hope it will be helpful for you.

FM-Radio reciever based on Arduino Nano and FM Module TEA5676

Schematics can be found in the schematics.png.
